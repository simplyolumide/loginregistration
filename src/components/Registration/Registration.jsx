...
function Registration() {
    ...
    function handleFormSubmit(e) {
        ...
        if (!user || !name || !email || !password || !phone || !profession) {
            setFlag(true);

        } else {
            setFlag(false);
            localStorage.setItem("hardikSubmissionUsername", JSON.stringify(user));
        ...
        <>
            ...
            {info ? <div> {login ? <form onSubmit={handleFormSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" placeholder="Enter Username" name="username" onChange={(event) => setUser(event.target.value)} />
                </div>
